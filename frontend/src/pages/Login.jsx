...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      try {
        ...
        showToast(
          error.response?.data?.message || firebaseError.message || "Login failed",
          "error"
        );
      }
    } finally {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      showToast(error.response?.data?.message || error.message || "Google login failed", "error");
    } finally {
  ...
  return (
    <div className="min-h-[calc(100vh-72px)] flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-950">
      <div className="w-full max-w-4xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden grid lg:grid-cols-2">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="remember" className="text-sm font-normal mb-0">
        ...
        {/* RIGHT SIDE: Branding/Image placeholder */}
